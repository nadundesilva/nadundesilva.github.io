...
const ScrollingComponent = (
    props: ScrollingComponentProps,
): React.ReactElement => {
    const {
        pageHeight,
        viewportHeight,
        div: { top: divTop, height: divHeight },
        isRefAvailable = true,
    } = props;
...
describe.each([
    ...
    "[page height: $pageHeight, div top: $divTop] $name",
    ({ pageHeight, divTop }: { pageHeight: number; divTop: number }) => {
        ...
        describe.each(
            ...
            "[viewport height: $viewportHeight] $name",
            ({ viewportHeight }: { viewportHeight: number }) => {
                ...
                const testData: TestData[] = [
                    ...
                    },
                    {
                        ...
                        if: viewportHeight < DIV_HEIGHT / 2,
                        viewportTop:
                            divTop + (DIV_HEIGHT / 2 - viewportHeight) / 2,
                        direction: 0,
                        offset: 1,
                    },
                    // viewport bottom at div halfway point
                    {
                        ...
                        if:
                            viewportHeight > DIV_HEIGHT &&
                            viewportHeight - DIV_HEIGHT / 2 <= divTop,
                    ...
                    (() => {
                        const offset =
                            viewportHeight / 2 > DIV_HEIGHT
                                ? Math.min(
                                      DIV_HEIGHT,
                                      divTop + DIV_HEIGHT - viewportHeight,
                                  ) / 2
                                : DIV_HEIGHT -
                                  viewportHeight / 2 +
                                  (viewportHeight / 2 - DIV_HEIGHT / 2) / 2;
                        return {
                            ...
                            if:
                                ...
                                viewportHeight / 2 <= divTop,
                            viewportTop:
                                divTop - viewportHeight + DIV_HEIGHT - offset,
                            direction: 1,
                            offset:
                                (DIV_HEIGHT - offset) / (viewportHeight / 2),
                        };
                    })(),
                    {
                    ...
                    },
                    {
                        ...
                        if:
                            viewportHeight * 0.75 <= divTop + DIV_HEIGHT / 2 &&
                            viewportHeight / 2 < DIV_HEIGHT,
                        viewportTop:
                            divTop -
                            viewportHeight / 2 +
                            (DIV_HEIGHT - viewportHeight / 2) / 2,
                        direction: 0,
                        offset: 1,
                    },
                    {
                    ...
                    {
                        name:
                            "viewport bottom between div halfway point and div bottom, with viewport top between div top and div halfway point, " +
                        ...
                        viewportTop:
                            ...
                            DIV_HEIGHT / 2 -
                            viewportHeight / 2 +
                            Math.ceil((DIV_HEIGHT - viewportHeight) / 4),
                        direction: 0,
                        offset: 1,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        viewportTop:
                            divTop +
                            DIV_HEIGHT / 2 +
                            Math.ceil((DIV_HEIGHT / 2 - viewportHeight) * 0.5),
                        direction: 0,
                        offset: 1,
                    },
                    // viewport bottom at div bottom
                    {
                        ...
                        if:
                            viewportHeight / 2 > DIV_HEIGHT &&
                            viewportHeight - DIV_HEIGHT <= divTop,
                    ...
                    // viewport bottom below div bottom
                    {
                        ...
                        direction: 1,
                        offset:
                            (DIV_HEIGHT + viewportHeight / 2) / viewportHeight,
                    },
                    {
                    ...
                    {
                        name:
                            "viewport bottom below div bottom, with div top between viewport top and viewport halfway point, " +
                            "with viewport halfway point above div halfway point",
                        if:
                            viewportHeight > DIV_HEIGHT &&
                            viewportHeight / 2 - DIV_HEIGHT / 2 <= divTop,
                        viewportTop:
                            divTop -
                            viewportHeight / 2 +
                            DIV_HEIGHT / 2 -
                    ...
                    },
                    {
                        ...
                        if:
                            ...
                            viewportHeight / 2 - DIV_HEIGHT / 2 <= divTop,
                        viewportTop:
                            divTop - viewportHeight / 2 + DIV_HEIGHT / 2,
                        direction: 0,
                        offset: 1,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        direction: -1,
                        offset:
                            (viewportHeight / 2 + DIV_HEIGHT) / viewportHeight,
                    },
                    {
                        name:
                            "viewport bottom below div bottom, with div top at viewport top, " +
                            "with viewport halfway point between div halfway point and div bottom",
                        if:
                            viewportHeight > DIV_HEIGHT &&
                            viewportHeight / 2 < DIV_HEIGHT,
                    ...
                    {
                        name:
                            "viewport bottom below div bottom, with viewport top between div top and div halfway point, " +
                            "with viewport halfway point between div halfway point and div bottom",
                        if:
                            viewportHeight / 2 < DIV_HEIGHT &&
                            viewportHeight > DIV_HEIGHT / 2,
                    ...
                    {
                        name:
                            "viewport bottom below div bottom, with viewport top at div halfway point, " +
                            "with viewport halfway point between div halfway point and div bottom",
                        if:
                            viewportHeight < DIV_HEIGHT &&
                            viewportHeight > DIV_HEIGHT / 2,
                    ...
                    },
                    {
                        ...
                        viewportTop:
                            ...
                            DIV_HEIGHT -
                            viewportHeight / 2 -
                            (DIV_HEIGHT / 2 - viewportHeight / 2) / 2,
                        direction: 0,
                        offset: 1,
                    },
                    {
                    ...
                    (() => {
                        const viewportTop =
                            ...
                            viewportHeight / 2 -
                            (DIV_HEIGHT / 2 - viewportHeight / 2) / 2;
                        const isDirectionBelow =
                            divTop - viewportTop + DIV_HEIGHT <
                            viewportHeight / 2;
                        return {
                            name:
                                "viewport bottom below div bottom, with viewport top between div halfway point and div bottom, " +
                ...
                test.each(
                    testData.filter(
                        (datum) => datum.if === undefined || datum.if,
                    ),
                )(
                    "[viewport top: $viewportTop, direction: $direction, offset: $offset] $name",
                    async ({
                        viewportTop,
                        direction,
                        offset,
                        ...
                        expect(pageHeight).toBeGreaterThanOrEqual(
