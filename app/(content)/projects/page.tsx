        ...
        <React.Fragment>
            ...
            <Section>
                ...
                <Paragraph>
                    ...
                    weeks or months. {Choreo} has many features which makes the
                    this possible such as AI assisted development, automated
                    deployments in a secure and highly available environment,
                    API Management, etc. Observability is one of the main areas
                    in this puzzle which makes the operations easier for the
                    users.
                </Paragraph>
                <Paragraph>
                    ...
                    {WSO2}, the Choreo project was focussing a lot on
            ...
            <Section>
                ...
                <Paragraph>
                    ...
                    targeting the development of cloud native applications
                    easier. One of the main features of {Ballerina} was the
                    built-in automated Observability. The automated
            ...
            <Section>
                ...
                <Paragraph>
                    ...
                    development of a complex microservices, across multiple
                    teams. {Cellery} introduces microservice composites along
                    with controls to reduce complexity and tools to improve
                    ...
                    Observability related of the framework. {Cellery} was built
                ...
                <Paragraph>
                    ...
                    resolution and visualisation to improve the experience
                    around deployments.
                </Paragraph>
                <HighlightsSection>
                    <li>
                    ...
                    <li>Guided several junior engineers and interns.</li>
                    <li>
            ...
            <Section>
                ...
                <Paragraph>
                    {Siddhi} has extensions model which adds many capabilities
                    to the streaming engine. While working as a Software
                    Engineering intern, I worked on the initial implementation
                    of {Siddhi} extensions within the extrema namespace, which
                    included extensions for finding the maximum and minimum
                    values in various ways in continuous event streams.
                    Moreover, during the Google Summer of Code project, I worked
                    on an autocomplete solution for the {Siddhi} editor for
                    providing completetions for siddhi syntax along with the
