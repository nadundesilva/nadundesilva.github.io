import telescopeImage from "@/assets/blog-articles/telescope.jpg";
import openTelemetryImage from "@/assets/blog-articles/observability/open-telemetry.webp";
import explainingImage from "@/assets/blog-articles/engineering/explaining.webp";
import freedomImage from "@/assets/blog-articles/engineering/freedom.webp";
...
<Image alt="OpenTelemetry Logo" src={openTelemetryImage} />
...
Previously there were few specifications for traces (OpenTracing) and metrics (Prometheus, Micrometer). However, some of these specifications such as Prometheus were vendor specific and all of them were created focusing on one area and not Observability as a whole.
