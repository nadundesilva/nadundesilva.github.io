...
The scope of the article is not to define best practices and is simply to articulate ways to reduce costs. However, you can read more about the best practices of Observability for Microservices deployed on Kubernetes in [my article](../kubernetes-the-right-way-observability-for-your-microservices-bcdaf33238ef) on it.
