import programming05Image from "@/assets/blog-articles/programming-05.webp";
import softwareEngineer1Image from "@/assets/blog-articles/engineering/software-engineer-1.webp";
import problem1Image from "@/assets/blog-articles/engineering/problem-1.webp";
import softwareEngineer2Image from "@/assets/blog-articles/engineering/software-engineer-2.webp";
import scalaImplicitConversionsImage from "@/assets/blog-articles/programming/scala-implicit-conversions.webp";
import parallelizedScoverageReport1Image from "@/assets/blog-articles/programming/parallelized-scoverage-report-1.webp";
import parallelizedScoverageReport2Image from "@/assets/blog-articles/programming/parallelized-scoverage-report-2.webp";

export const blogMetadata = {
    image: programming05Image,
    mediumUrl:
...
In this article, I will be focusing on solving a problem that I encountered while running the [SCoverage maven plugin](https://github.com/scoverage/scoverage-maven-plugin)'s report goal in a Maven parallel build. However, the solution is relatable to other plugins which have a similar structure such as Maven Surefire Plugin.
...
<Image alt="Problem" src={problem1Image} />
...
<Image
    alt="Parallelized SCoverage Report"
    src={parallelizedScoverageReport1Image}
/>
...
<Image
    alt="Parallelized SCoverage Report"
    src={parallelizedScoverageReport2Image}
/>
