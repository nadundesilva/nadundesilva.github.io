import celleryImage from "@/assets/blog-articles/cellery.webp";
import celleryToTheRescueImage from "@/assets/blog-articles/cellery/cellery-to-the-rescue.webp";
import celleryViewCellImage from "@/assets/blog-articles/cellery/cellery-view-cell.webp";
import traditionalMicroservicesToCelleryCellsImage from "@/assets/blog-articles/cellery/traditional-microservices-to-cellery-cells.webp";
import celleryHubFrontendImage from "@/assets/blog-articles/cellery/cellery-hub-frontend.webp";
...
<Image alt="Cellery to the Rescue" src={celleryToTheRescueImage} />
...
<Image alt="Cellery View Command Output Cell" src={celleryViewCellImage} />
...
<Image
    ...
    src={traditionalMicroservicesToCelleryCellsImage}
/>
...
<Image alt="Cellery Hub Frontend" src={celleryHubFrontendImage} />
