import celleryOnMicroK8sImage from "@/assets/blog-articles/cellery-on-microk8s.webp";
import microk8sStatusOutputImage from "@/assets/blog-articles/cellery/microk8s-status-output.webp";
import microk8sDnsEnableOutputImage from "@/assets/blog-articles/cellery/microk8s-dns-enable-output.webp";
import kubectlConfigCurrentContextOutputImage from "@/assets/blog-articles/cellery/kubectl-config-current-context-output.webp";
import microk8sInspectOutputImage from "@/assets/blog-articles/cellery/microk8s-inspect-output.webp";
import celleryVersionOutputImage from "@/assets/blog-articles/cellery/cellery-version-output.webp";
import k8sLoadBalancerServiceYamlImage from "@/assets/blog-articles/cellery/k8s-load-balancer-service-yaml.webp";
import cellerySetupCreateExistingOutputImage from "@/assets/blog-articles/cellery/cellery-setup-create-existing-output.webp";
import celleryRunCellOutputImage from "@/assets/blog-articles/cellery/cellery-run-cell-output.webp";
import celleryListInstancesOutputImage from "@/assets/blog-articles/cellery/cellery-list-instances-output.webp";
import cellFrontendImage from "@/assets/blog-articles/cellery/cell-frontend.webp";

export const blogMetadata = {
    image: celleryOnMicroK8sImage,
    mediumUrl:
...
<Image alt="MicroK8s Status Output" src={microk8sStatusOutputImage} />
...
<Image alt="MicroK8s Enable DNS Output" src={microk8sDnsEnableOutputImage} />
...
<Image
    ...
    src={kubectlConfigCurrentContextOutputImage}
/>
...
<Image alt="MicroK8s Inspect Output" src={microk8sInspectOutputImage} />
...
<Image alt="Cellery Version Output" src={celleryVersionOutputImage} />
...
<Image
    alt="K8s Load Balancer Service Yaml"
    src={k8sLoadBalancerServiceYamlImage}
/>
...
<Image
    ...
    src={cellerySetupCreateExistingOutputImage}
/>
...
<Image alt="Cellery Run Cell Output" src={celleryRunCellOutputImage} />
...
<Image
    alt="Cellery List Instances Output"
    src={celleryListInstancesOutputImage}
/>

To access the application we deployed, visit http://pet-store.com using your browser.

<Image alt="Cell Frontend" src={cellFrontendImage} />
