import metricsImage from "@/assets/blog-articles/metrics.jpg";
import thinking2Image from "@/assets/blog-articles/engineering/thinking-2.webp";
import kubernetes2Image from "@/assets/blog-articles/devops/kubernetes-2.webp";
import containerShipImage from "@/assets/blog-articles/miscellaneous/container-ship.webp";
import networkCablesImage from "@/assets/blog-articles/devops/network-cables.webp";
import warehouseImage from "@/assets/blog-articles/miscellaneous/warehouse.webp";
import softwareEngineer5Image from "@/assets/blog-articles/engineering/software-engineer-5.webp";
...
Another important aspect to consider when you are working on a large microservices deployment is to have a consistent but machine-readable logging format. The general pattern encouraged in Kubernetes is to write all logs to stdout and stderr so that they are recorded in each Kubernetes node in their corresponding logging directories. This is generally collected by a logs agent (such as [Fluentd](https://www.fluentd.org/)), parsed, and sent to a centralized log collection system, to be analyzed based on the requirements.
