import kubernetesClusterImage from "@/assets/blog-articles/kubernetes-cluster.webp";

export const blogMetadata = {
    image: kubernetesClusterImage,
    mediumUrl:
...
According to the above example, all Pods which do not have the `priorityClassName` field would have a priority value of `100`.
