import programming03Image from "@/assets/blog-articles/programming-03.webp";

export const blogMetadata = {
    image: programming03Image,
    mediumUrl:
...
However, we may need to specify the retention policy where we might not need the annotations in the class files or we need them at run-time to be read by a program. This can be done by adding the [`@Retention{:java}`](https://docs.oracle.com/javase/8/docs/api/java/lang/annotation/Retention.html) annotation and passing the [retention policy](https://docs.oracle.com/javase/7/docs/api/java/lang/annotation/RetentionPolicy.html) into it.
