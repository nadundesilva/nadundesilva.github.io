            ...
            <Layout>
                <LayoutContent>
                    <Section>
                        ...
                        />
                        <Paragraph>
                            Each year for employees who have performed
                    ...
                    <Section>
                        ...
                        />
                        <Paragraph>
                            During my B.Sc. (Hons.) in Engineering (Computer
                            Science and Engineering) degree at the University of
                    ...
                    <Section>
                        ...
                        />
                        <Paragraph>
                            We came up with a platform to map and compare
                            population genetics of a species with landscape
                            features, climate conditions, and human activities
                            in a region to identify potential barriers or
                            facilitators to gene migration and local adaptation.
                            The platform at its core utilizes a clustering
                            algorithm for identifying patterns for identifying
                            any such barriers.
                        </Paragraph>
                    </Section>
                    <Section>
                        ...
                        <Paragraph>
                            ...
                            experience as well. We were presented with an
                            honorable mention for this solution.
                        </Paragraph>
                    </Section>
                    <Section>
                        ...
                        <Photo
                            float={"left"}
                            photo={Photos.AngelHack2016Bike}
                        />
                        <Paragraph>
                            The game maps the user&lsquo;s movement on the
                            bicycle to movements on the game. The user is
                            presented with targets which they can achieve by
                            collecting coins in their path. In the final round
                            where the finalists were tasked with developing
                            their concepts within a limited time frame, we
                            developed a working prototype which the judges were
                            able to try out as well.
                        </Paragraph>
                        <Paragraph>
                            The game was built using Unity which received the
                            signal from the sensor attached to the exercise
                            bicycle. The speed at which the user pedaled the
                            bicycle forward was mapped into the speed at which
                            the user moved within the game and the slight
                            movements of the head was mapped into the bicycle
                            making small turns. The path forward was designed to
                            avoid too much strain on the neck, but to simply
                            provide an enjoyable game for the user to enjoy
                    ...
                    <Section>
                        ...
                        <Paragraph>
                            ...
                            bootstrap businesses in the area.
                        </Paragraph>
                    </Section>
                    <Section>
                        <SectionHeading>
                        ...
                        <Paragraph>
                            ...
                            along with a prototype, in the hope of
                            revolutionizing education.
                        </Paragraph>
                        <Photo
                            float={"left"}
                            photo={
                                Photos.HSBCYouthEnterpriseAwards2015Discussion
                            }
                        />
                        <Paragraph>
                            Although there is so much online content, many
                            people still prefer to use books. However, there are
                            many occasions where the written word and diagrams
                            are not enough to understand complex concepts. The
                            proposed system visualized drawings using augmented
                            reality to help students study them easily.
                        </Paragraph>
                    </Section>
                </LayoutContent>
            </Layout>
